...
func TestImperation_String(t *testing.T) {
	...
	for testNumber, test := range tests {
		...
		var imperation Imperation

		imperation.loaded = true
		imperation.verb  = test.Verb
		imperation.object = test.Object

		var actual   string = imperation.String()
